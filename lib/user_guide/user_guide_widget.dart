                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'Find amazing product to try-on',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .titleSmall
                                                .override(
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 0.0, 20.0),
                                        child: SvgPicture.asset(
                                          'assets/images/Swipe_Profiles-pana.svg',
                                          width: 300.0,
                                          height: 300.0,
                                          fit: BoxFit.fitWidth,
                                        ),
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'Try-on your product using Live AR',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .titleSmall
                                                .override(
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 30.0, 0.0, 30.0),
                                        child: SvgPicture.asset(
                                          'assets/images/In_no_time-pana_(1).svg',
                                          width: 300.0,
                                          height: 250.0,
                                          fit: BoxFit.fitWidth,
                                        ),
                        ...
                        child: Padding(
                          ...
                          child: smooth_page_indicator.SmoothPageIndicator(
                            ...
                            effect: smooth_page_indicator.ExpandingDotsEffect(
                              ...
                              activeDotColor: Color(0xFFAEFA24),
